(function () {
  const normal = {
    ...
    // [手機] 滾動，上選固定
    topSlidersFixed() {
      this.data.windowScrollTop > 30 ? $('.wrap').addClass('top-tabs--fixed') : $('.wrap').removeClass('top-tabs--fixed');
    },
    ...
    topSliders() {
      ...
      let topTabsSlider = new Swiper('.top-tabs__swiper', {
        ...
        navigation: {
          nextEl: '.top-tabs .swiper-button-next',
          prevEl: '.top-tabs .swiper-button-prev',
        },
      });
